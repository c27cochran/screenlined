...
$question = $_GET['recorderId'];
$recorder_time = substr($question, 0, strpos($question, '/'));  
$stream= ltrim($question, $recorder_time);
...
$config['connectionstring']='rtmp://54.209.139.207/hdfvr/screenlined';
...
$config['qualityurl']='audio_video_quality_profiles/wide/640x360x30x90.xml';

//maxRecordingTime: Number
//desc: the maximum recording time in seconds
//values: any number greater than 0;
//default:120
$config['maxRecordingTime']=$recorder_time;
...
$config["backgroundColor"] = 0x666666;
...
$config["streamName"] = 'mp4:'. $username . "/" . $stream;
